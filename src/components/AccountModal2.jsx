              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                >
                  ...
                  <div className="button text-center mt-5">
                    {' '}
                    <button className="bg-blue-100 rounded-lg w-1/2 text-center px-3 py-2 hover:bg-blue-300">
                      Log In
                    </button>
                    {error == 'log-in' ? (
                ...
                <div className="button text-center m-5 font-game flex justify-center">
                  <button
                    className="inline-flex justify-center rounded-md border border-transparent bg-white px-3 py-1 text-sm font-medium text-blue-400 hover:bg-gray-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
                    onClick={e => {
                      e.stopPropagation();
