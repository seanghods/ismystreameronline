...
export default function NavBar() {
  ...
  return (
    <div className="nav-bar-section h-full flex-col w-[200px] hidden lg:flex">
      <div className="nav-bar text-sm border-2 border-gray-300 w-full mx-3 md:mx-7 rounded-lg text-black shadow-xl dark:shadow-[#89bcff] shadow-[#bbd8ff] font-bold text-center overflow-y-auto sticky top-20">
          ...
          {gamesData.slice(0, 6).map((game, index) => {
            return (
              <NavLink
                ...
                className={({ isActive }) =>
                  [
                    'outline outline-1 py-4 outline-gray-50 dark:outline-gray-600 p-1 transform transition duration-250 shadow-md shadow-black font-gamebold tracking-tight hover:text-white hover:bg-gradient-to-r hover:from-[#acaffd] hover:to-[#7bb4ff]',
