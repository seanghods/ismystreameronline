  ...
  return (
    <div className="w-full flex justify-center mb-14">
      <div className="w-4/5 md:w-1/2 font-game flex flex-col gap-5">
        <h1 className="text-center text-lg font-gamebold">Privacy Policy</h1>
        <p className="text-right">Last updated: November 29, 2023</p>
        <p>
        ...
        <ul className="list-disc pl-3">
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Is My Streamer Online.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Is My Streamer Online,
              accessible from{' '}
              <a
        ...
        <ul className="list-disc pl-3">
          <li>By email: ismystreameronline@gmail.com</li>
        </ul>
      </div>
    </div>
  );
