export default function TermsOfService() {
  return (
    <div className="w-full flex justify-center mb-14">
      <div className="w-4/5 md:w-1/2 font-game flex flex-col gap-5">
        <h1 className="text-center text-lg font-gamebold">Terms of Service</h1>

        <p>Welcome to Is My Streamer Online!</p>

        <p>
          These terms of service outline the rules and regulations for the use
          of Is My Streamer Online&apos;s Website, located at
          https://www.ismystreameronline.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Is My Streamer Online if you do not
        ...
        <p>
          We employ the use of cookies. By accessing Is My Streamer Online, you
        ...
        <p>
          Unless otherwise stated, Is My Streamer Online and/or its licensors
          own the intellectual property rights for all material on Is My
          Streamer Online. All intellectual property rights are reserved. You
          may access this from Is My Streamer Online for your own personal use
          subjected to restrictions set in these terms of service.
        </p>

        <p>You must not:</p>
        <ul className="list-disc pl-3">
          <li>Republish material from Is My Streamer Online</li>
          <li>Sell, rent or sub-license material from Is My Streamer Online</li>
          <li>
            Reproduce, duplicate or copy material from Is My Streamer Online
          </li>
          <li>Redistribute content from Is My Streamer Online</li>
        </ul>
        ...
        <p>
          ...
          exchange opinions and information in certain areas of the website. Is
          My Streamer Online does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of Is My Streamer Online,its agents and/or
          ...
          laws, Is My Streamer Online shall not be liable for the Comments or
        ...
        <p>
          Is My Streamer Online reserves the right to monitor all Comments and
        ...
        <p>
          You hereby grant Is My Streamer Online a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Is My Streamer Online; and
        ...
        <p>
          ...
          sending an e-mail to Is My Streamer Online. Please include your name,
        ...
        <p>
          No use of Is My Streamer Online&apos;s logo or other artwork will be
